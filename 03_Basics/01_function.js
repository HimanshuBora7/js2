...
function calculateCartPrice(...num1) {
  // ... ->these three dots are called as both rest and spread operator its depend on the context in which we are using it here we want function to take infinite number of arguments coz we are not certain how many parameters will be passed
  return num1;
}
